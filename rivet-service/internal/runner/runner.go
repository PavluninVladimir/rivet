...
// Версия 9: политика проекта в назначении и её хэш в результате стадии
// (add-policy-delivery); v8 — обратный канал контекста; v7 — промпт
// пользователя в Assignment; v6 — адаптер и глубина данных,
// структурированные шаги; v5 — токены регистрации, v4 — репозиторий
// проекта, v3 — деплой-джобы, v2 — session_id. Runner'ы младших версий
