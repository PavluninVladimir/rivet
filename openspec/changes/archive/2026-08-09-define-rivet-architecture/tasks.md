...
- [x] 2.3 Dogfooding-прогон: Epic в репозитории rivet, реальная задача через полный цикл (Claude Code в обёртке, PR на GitHub, review вторым runner'ом, merge кнопкой) — сценарий первой демонстрации из требований
